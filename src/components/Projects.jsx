...
import { PROJECTS } from "../constants"; // ✅ Import PROJECTS
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {PROJECTS.map((project, index) => (
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            variants={projectVariables} // ✅ Fixed: Used the correct animation variable
          >
            <img
              src={project.image}
              alt={project.name}
            ...
            <div className="relative z-20 p-6 flex flex-col justify-between h-full bg-black/30 text-white">
              ...
              <div className="flex flex-col justify-between">
                ...
                <a
                  href={project.link}
                  target="_blank"
                  rel="noopener noreferrer" // ✅ Fixed typo in noreferrer

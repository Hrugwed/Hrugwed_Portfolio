...
import jason from "../assets/WhatsApp Image 2025-02-21 at 11.11.48_e7f347b0.jpg";
import { HERO_CONTENT } from "../constants"; // ✅ Import HERO_CONTENT
    ...
    return (
        <section>
            <div className="relative z-10 min-h-screen flex flex-wrap flex-col md:flex-row items-center justify-center text-white">
                ...
                <motion.div className="w-full md:w-1/2 p-8 flex justify-center" initial="hidden" animate="visible" variants={imageVariants}>
